...
insert into clients (
  ...
  'Thanks for calling Summit Heating and Air! This is Sunny, the AI assistant — everyone on the team is helping other customers right now, but I can get you taken care of. What''s going on?',
  'Thanks for calling Summit Heating and Air! This is Sunny, the AI assistant. The office is closed right now, but I can help you book for tomorrow, or if this is an emergency I can connect you to our on-call tech. Which would you like to do?',
